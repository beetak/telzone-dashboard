...
import TelOneTownList from "../../../TelOneTowns/TelOneTownList/TelOneTownList";
import TelOneTownPost from "../../../TelOneTowns/TelOneTownPost/TelOneTownPost";
          ...
          <div className="card my-4">
            <div className="position-relative mt-n4 mx-3 z-index-2" style={Style2}>
              <div className="row bg-gradient-primary shadow-primary border-radius-lg mt-n4 mx-3" style={Style2}>
                <div className="row">
                  <div className="col-9">
                    <h6 className="text-white text-capitalize ps-3">Town Details</h6>
                  </div>
