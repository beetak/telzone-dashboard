...
import InboxCard from '../DistributionCard/InboxCard';
    ...
    if(count>0){
      renderedBundles = (
        bundles.map((bundle, index)=>(
          <tr key={index}>
            <InboxCard data={bundle} index={index}/>
          </tr>
        ))
      )
    }
        ...
        <table className="table align-items-center mb-0">
          <thead>
            <tr>
              ...
              <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Sent By</th>
