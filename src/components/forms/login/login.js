      ...
      const user ={
        ...
        .then((response) => {
          ...
          if(response.data.code === 'SUCCESS'){
            ...
            localStorage.setItem('regionId', response.data.data.region.id)
            localStorage.setItem('regionName', response.data.data.region.name)
            localStorage.setItem('townId', response.data.data.town.id)
            localStorage.setItem('townName', response.data.data.town.name)
