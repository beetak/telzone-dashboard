...
export default class SalesGenResponse extends Component{
            ...
            {this.state.response ? (
                <div className="card-body px-0 pb-2" style={Style1}>
                    <div className="table-responsive p-0">
                        <h1 className="mb-0 "><i className="fa fa-money cursor-pointer" /></h1>
                        <p className="text-sm ">Voucher Sales</p>
                        <hr className="dark horizontal" />
                        <div className="">
                            <p className="mb-0 text-sm">{this.state.response}</p>
                            <br/>
                            <p className="mb-0 text-sm">Batch Number: {this.state.batchName}</p>
                        </div>
                    </div>
                </div>
            ) : (
                <div className="card-body px-0 pb-2" style={Style1}>
                    <div className="table-responsive p-0">
                        <h1 className="mb-0 " style={{lineHeight: "100px"}}><i className="fa fa-money cursor-pointer" /></h1>
                        <p className="text-sm ">Voucher Sales</p>
                        <hr className="dark horizontal" />
                        <div className="">
                            <p className="mb-0 text-sm" style={Style1}>Use the form to sale batches of vouchers</p>
                        </div>
                    </div>
                </div>
            )}
