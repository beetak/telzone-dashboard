        ...
        <div>
            ...
            <main className="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                ...
                */}
                ...
                {
                    voucherView === 'idle' && userRole === 'Super Admin'? 
                        <RechargeDetails/>
                        :(voucherView === 'pending' && userRole === 'Super Admin'?
                            loadingAnimation
                        :(voucherView === 'fulfilled' && userRole === 'Super Admin'?
                            <BatchVoucherDetails/>
                            :(voucherView === 'rejected' && userRole === 'Super Admin'?
                                errorMsg:''
                        )
                    ))
                }
